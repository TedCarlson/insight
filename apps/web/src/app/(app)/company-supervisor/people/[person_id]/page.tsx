// path: apps/web/src/app/(app)/company-supervisor/people/[person_id]/page.tsx
...
export default async function CompanySupervisorPersonRecordPage({
  params,
  searchParams,
}: Props) {
  const { person_id } = await params;
  const search = searchParams ? await searchParams : {};
  const returnTo = search.returnTo ?? "/company-supervisor/people";
