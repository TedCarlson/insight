...
export default async function AdminPlanningPage(props: { searchParams?: Promise<any> }) {
    ...
    return (
      <div className="mt-6 rounded-2xl border border-[var(--to-border)] bg-[var(--to-surface)] p-4">
        ...
        <div className="mt-1 text-sm text-[var(--to-ink-muted)]">
          Missing <code className="text-xs">pc_org_id</code>. Admin will get a PC Org selector here next.
        </div>
