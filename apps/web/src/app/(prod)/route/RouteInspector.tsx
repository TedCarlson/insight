...
function getCode(row: RouteRow | null | undefined): string {
  return String(row?.route_code ?? row?.code ?? '')
}

function getActive(row: RouteRow | null | undefined): boolean {
...
export default function RouteInspector(props: {
  ...
  const { open, mode, route, onChange, onCreate, onDelete, onClose } = props
  ...
  const nameValue = isCreate ? draftName : getName(route)
  const codeValue = isCreate ? draftCode : getCode(route)
  const activeValue = isCreate ? draftActive : getActive(route)
          ...
          <div className="col-span-12">
            ...
            <input
              ...
              onChange={(e) => {
                ...
                else if (routeId) onChange(routeId, 'name', v)
              }}
          ...
          <div className="col-span-12 sm:col-span-6">
            ...
            <input
              ...
              onChange={(e) => {
                ...
                else if (routeId) onChange(routeId, 'code', v)
              }}
            ...
            <div className="mt-2 flex items-center gap-2">
              <input
                ...
                onChange={(e) => {
                  ...
                  else if (routeId) onChange(routeId, 'active', v)
                }}
              />
