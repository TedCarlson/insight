// path: apps/web/src/features/role-company-supervisor/components/CompanySupervisorScopedViewClient.tsx
...
export default function CompanySupervisorScopedViewClient({
  ...
  function updateUrl(nextClass: ReportClassType, nextRange: MetricsRangeKey) {
    ...
    router.push(`/company-supervisor/metrics?${params.toString()}`);
  }
