// path: apps/web/src/features/role-company-supervisor/pages/CompanySupervisorWorkforcePageShell.tsx
...
export default async function CompanySupervisorWorkforcePageShell(props: Props) {
