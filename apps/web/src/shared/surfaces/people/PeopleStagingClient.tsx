...
export function PeopleStagingClient() {
    ...
    useEffect(() => {
        ...
        async function load() {
            ...
            const res = await fetch(`/api/people/staging-search?${params.toString()}`);
            ...
            <Card className="p-4">
                <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <input
                        ...
                        placeholder="Search name, email, phone, NT login, CSG, affiliation…"
                        className="h-10 w-full rounded-xl border px-3 text-sm lg:w-96"
                    />
                </div>
                        ...
                        <table className="min-w-full border-collapse">
                            <thead>
                                <tr className="border-b text-[11px]">
                                    ...
                                    <th className="px-3 py-3 text-left">Assignment State</th>
                            ...
                            <tbody>
                                {filteredRows.map((row) => (
                                    <tr key={row.person_id} className="border-b">
                                        ...
                                        <td className="px-3 py-3 text-sm">{assignmentLabel(row)}</td>
